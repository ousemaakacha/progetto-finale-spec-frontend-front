...
function HomePage() {
    ...
    // funzione per caricamento solo se la ricerca/categoria varia
    useEffect(() => {
    ...
    // funzione per avvio caricamento cibi durante montaggio componente
    useEffect(() => {
    ...
    // funzione per ricavare le uniche categorie dei cibi inizialmente impostatto su ordine alfabetico
    ...
    return uniqueCategories.sort((a, b) => a.localeCompare(b));
     ...
     // funzione ordinamento cibi per criterio scelto senza modifica del array iniziale
